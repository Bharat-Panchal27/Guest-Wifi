      ...
      >
        ...
        <div className="space-y-6 text-base">
          <div className="grid grid-cols-2 gap-y-4">
            ...
            <div className="flex">
              <span className="font-semibold text-gray-700">Number of Devices:&nbsp;</span>
            ...
            <div className="flex">
              <span className="font-semibold text-gray-700">Whom to Meet:&nbsp;</span>
            ...
            <div className="flex">
              <span className="font-semibold text-gray-700">Head Email:&nbsp;</span>
              <span className="text-gray-900">{data?.headEmail}</span>
            </div>
            <div className="flex">
              <span className="font-semibold text-gray-700">Access Required:&nbsp;</span>
